...
void loop(void) {
    ...
    if (p3==1) {
        if (bt) {
            ...
            digitalWrite((c-1+COL1),led[c-1][r-1]);
            digitalWrite((r-1+ROW1),led[c-1][r-1]);
            Serial.print("CR=");
            Serial.print(c);
            Serial.print("x");
            Serial.print(r);
            Serial.print(" led=");
            Serial.println(led[c-1][r-1]);
            lcd.setCursor(4,1);
            lcd.print(c);
            lcd.setCursor(6,1);
            lcd.print(r);
        ...
        for(c=0;c<8;c++) {
            for (r=0;r<4;r++) {
                ...
                lcd.setCursor(6,1);
                lcd.print(r+1);
                digitalWrite((c+COL1),HIGH);
                digitalWrite((r+ROW1),HIGH);
                delay(500);
                digitalWrite((c+COL1),LOW);
                digitalWrite((r+ROW1),LOW);
            }
        }
    }
}
